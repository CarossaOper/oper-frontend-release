<template>
    <div class="w-11/12 lg:border-x-0 border border-black flex lg:flex-row flex-col lg:justify-between lg:items-center font-noto text-lg mx-auto">
        ...
        <a v-if="!sold" class="border border-black flex flex-row items-center px-3 py lg:mr-2 w-fit lg:mx-0 mx-auto my-1 lg:my-0" href="#">
        ...
        <a v-else class="border border-red-400 flex flex-row items-center px-3 py lg:mr-2 text-red-400 hover:cursor-not-allowed w-fit lg:mx-0 mx-auto my-1 lg:my-0" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2">
